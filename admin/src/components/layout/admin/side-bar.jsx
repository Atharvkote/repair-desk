  ...
  const sections = [
    {
      title: t("workspace"),
      items: [
        { label: t("overview"), icon: FaHome, href: "/" },
        {
          label: t("services"),
          icon: FaFolderOpen,
          href: "#",
          id: "services",
          subItems: [
            { label: t("newService"), icon: PlusIcon, href: "/service" },
            { label: t("activeServices"), icon: FaLocationArrow, href: "/service/list" },
          ],
        },
        { label: t("history"), icon: FaUserClock, href: "/history" },
        {
          label: t("catalog"),
          icon: SiBookstack,
          href: "#",
          id: "catalog",
          subItems: [
            { label: t("serviceCatalog"), icon: FaCircleNodes, href: "/catalog/services" },
            { label: t("partsCatalog"), icon: FaInbox, href: "/catalog/parts" },
          ],
        },
        { label: t("reports"), icon: IoBarChartSharp, href: "/reports" },
      ],
    },
    {
      title: t("admin"),
      items: [
        { label: t("company"), icon: AppWindowMacIcon, href: "/company" },
        { label: t("teams"), icon: Users2, href: "/teams" },
